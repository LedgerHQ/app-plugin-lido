...
#ifdef HAVE_BAGL
        #include "bagl.h"
        const bagl_icon_details_t C_icon_left = { GLYPH_icon_left_WIDTH, GLYPH_icon_left_HEIGHT, 1, C_icon_down_colors, C_icon_left_bitmap };
        #endif // HAVE_BAGL
#include "glyphs.h"
...
#ifdef HAVE_BAGL
        #include "bagl.h"
        const bagl_icon_details_t C_icon_right = { GLYPH_icon_right_WIDTH, GLYPH_icon_right_HEIGHT, 1, C_icon_down_colors, C_icon_right_bitmap };
        #endif // HAVE_BAGL
#include "glyphs.h"
...
#ifdef HAVE_BAGL
        #include "bagl.h"
        const bagl_icon_details_t C_icon_up = { GLYPH_icon_up_WIDTH, GLYPH_icon_up_HEIGHT, 1, C_icon_down_colors, C_icon_up_bitmap };
        #endif // HAVE_BAGL
#include "glyphs.h"
...
#ifdef HAVE_BAGL
        #include "bagl.h"
        const bagl_icon_details_t C_icon_warning = { GLYPH_icon_warning_WIDTH, GLYPH_icon_warning_HEIGHT, 1, C_icon_down_colors, C_icon_warning_bitmap };
        #endif // HAVE_BAGL
